...
class Permission extends Model
{
    ...
    protected static array $permissions = [
        'websocket' => [
            ...
            'keys' => [
                'connect' => '允许用户连接到服务器的 websocket 服务器以流式传输控制台。',
            ],
        ],
        ...
        'database' => [
            ...
            'keys' => [
                ...
                'update' => '允许用户重置数据库服务器的密码。如果用户没有 view_password 权限，他们将看不到更新的密码。',
                'delete' => '允许用户从此服务器中删除数据库服务器。',
                'view_password' => '允许用户查看与此服务器的数据库服务器关联的密码。',
            ],
        ],
