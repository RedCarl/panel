...
return [
    ...
    'nest' => [
        'delete_has_servers' => '无法从面板中删除关联了实例的预设组。',
        'egg' => [
            'delete_has_servers' => '无法从面板中删除关联了实例的预设。',
    ...
    'subusers' => [
        ...
        'user_is_owner' => '您不能将实例所有者添加为此实例的子用户。',
        'subuser_exists' => '具有该电子邮箱地址的用户已被指定为该实例的子用户。',
    ],
    'databases' => [
        'delete_has_databases' => '无法删除关联了数据库的数据库主机实例。',
    ],
    'tasks' => [
    ...
    'api' => [
        'resource_not_found' => '请求的资源在此实例上不存在。',
    ],
];
