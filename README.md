...
我们通过使用 Docker 容器隔离每个服务器来支持各种游戏，为您提供强大的功能
在全球范围内托管您的游戏，而不必让每台物理机器都因安装额外的依赖而变得臃肿。

### 额外增加的功能:

-   服务器分组功能,新增服务器时名称填写规则：域#组名:组名:组名 可以对服务器很多的情况进行分组，更方便管理服务器。
-   对首页的服务器列表显示进行重写，更方便操作。
-   首页服务器列表权限修改，普通用户只能看到自己的服务器，管理员用户可以看到所有服务器。
